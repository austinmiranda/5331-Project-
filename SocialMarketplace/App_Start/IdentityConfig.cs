...
namespace SocialMarketplace
{
    ...
    public class ApplicationUserManager : UserManager<User,int>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<User, CustomRole, int,
                                    CustomUserLogin, CustomUserRole, CustomUserClaim>(context.Get<ApplicationDbContext>()));
